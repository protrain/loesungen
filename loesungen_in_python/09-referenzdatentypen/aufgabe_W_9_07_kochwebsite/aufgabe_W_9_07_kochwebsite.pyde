...
class Kochrezept:
    ...
    def __init__(self, name, zeit, zutaten, anweisungen, anweisungHerd):
        self.name = name
        self.zeit = zeit
        self.anweisungen = anweisungen
        self.zutaten = zutaten
        self.anweisungHerd = anweisungHerd
...
anweisungHerd = "Pfanne auf hoher Stufe erhitzen und Teig"
anweisungHerd += "portionsweise im heißen Öl ausbacken."
