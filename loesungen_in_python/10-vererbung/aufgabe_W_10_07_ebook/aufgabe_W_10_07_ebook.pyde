...
class Ebook:
    ...
    def __str__(self):
        output = "Ebook: " + self.__author + \
            " (" + str(self.__year) + ")\n"
        output += "Seiten: " + str(self.num_pages()) + "\n"
        output += "-------\n"
...
class MediaAsset(object):
    ...
    def __str__(self):
        return self.__file + " (" + str(self.num_pages()) + " Seiten)\n"
...
class TextAsset(MediaAsset):
    ...
    def __init__(self, file, size, language, num_chars):
    ...
    def num_pages(self):
        return self.__num_chars / 2000.0
...
testBook.add_asset(TextAsset("Aufgabe 1", 12, "Deutsch", 3444))
testBook.add_asset(AudioAsset("Audio 1", 12, "Deutsch", 95))
testBook.add_asset(VideoAsset("Video 1", 12, "Deutsch", 95, 800, 800))
testBook.add_asset(PictureAsset("Bild 1", 12, "Deutsch", 2000, 600))
testBook.add_asset(TextAsset("Aufgabe 2", 12, "Deutsch", 7655))
print(testBook)
