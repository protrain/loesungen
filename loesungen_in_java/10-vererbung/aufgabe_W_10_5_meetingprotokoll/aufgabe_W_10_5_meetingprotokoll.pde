...
public class MeetingMinutes {
  ...
  public String toString() {
    String output = "Meeting: " + date + " (" + timeframe + "), " 
                    + room + "\n";
...
public void setup() {
  ...
  meeting.add(
    new DecisionItem("Dem Antrag wurde einstimmig zugestimmt.")
  );
  meeting.add(
    new ActionItem("Bis zum nächsten Meeting muss Kapitel 9 fertig "
      +"gestellt sein.")
  );
